...
const TechBadge = ({ children }: { children: React.ReactNode }) => (
  <span className="px-2 py-1 bg-[var(--bg-input)] border border-theme text-theme-secondary rounded text-xs font-mono mr-2 mb-2 inline-block">
    {children}
  </span>
);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-8">
            ...
            <div className="bg-[var(--bg-card)] rounded-2xl border border-theme p-6">
                <h2 className="text-lg font-bold text-heading mb-4 border-b border-theme pb-2">Objectifs du Microservice</h2>
            ...
            {/* TECH STACK */}
            <div className="bg-[var(--bg-card)] rounded-2xl border border-theme p-6">
                <h2 className="text-lg font-bold text-heading mb-4 border-b border-theme pb-2">Stack Technique</h2>
                <div className="space-y-4">
                    <div>
                        <div className="text-xs uppercase text-theme-muted font-bold mb-2">Orchestration</div>
                        <div>
                    ...
                    <div>
                        <div className="text-xs uppercase text-theme-muted font-bold mb-2">Intelligence Artificielle</div>
                        <div>
                    ...
                    <div>
                        <div className="text-xs uppercase text-theme-muted font-bold mb-2">Unity / MCP</div>
                        <div>
        ...
        <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-[var(--bg-card)] rounded-2xl border border-theme p-6">
                 ...
                 <div className="space-y-4 text-sm">
                     ...
                     <div className="flex items-center p-3 bg-[var(--bg-tertiary)] rounded-lg border border-theme">
                        <div className="w-8 h-8 rounded-full bg-[var(--bg-input)] flex items-center justify-center text-heading font-bold mr-4">2</div>
                        <div>
                            <strong className="text-[#FF8C66]">Génération</strong>
                            <p className="text-[var(--text-tertiary)]">Microservice crée le fichier .glb ou le script .cs.</p>
                        </div>
                     </div>
                     ...
                     <div className="flex items-center p-3 bg-[var(--bg-tertiary)] rounded-lg border border-theme">
                        <div className="w-8 h-8 rounded-full bg-[var(--bg-input)] flex items-center justify-center text-heading font-bold mr-4">4</div>
                        <div>
                            <strong className="text-[#FF8C66]">Exécution Unity</strong>
                            <p className="text-[var(--text-tertiary)]">Unity reçoit les commandes et met à jour la scène en temps réel.</p>
                        </div>
                     </div>
                 </div>
            </div>
            ...
            <div className="bg-[var(--bg-card)] rounded-2xl border border-theme p-6">
                ...
                <div className="space-y-6 relative border-l-2 border-theme ml-3 pl-8">
                    ...
                    <div className="relative">
                        ...
                        <h3 className="text-md font-bold text-heading">Phase 1 : Infrastructure & Ingestion</h3>
                        <span className="text-xs font-mono text-theme-muted mb-2 block">Sprints 1-2</span>
                    ...
                    <div className="relative">
                        <div className="absolute -left-[41px] bg-[var(--bg-input)] border-4 border-[var(--bg-card)] w-6 h-6 rounded-full"></div>
                        <h3 className="text-md font-bold text-heading">Phase 2 : Le Cerveau - LLM & Extraction</h3>
                        <span className="text-xs font-mono text-theme-muted mb-2 block">Sprints 3-4</span>
                        <ul className="list-disc list-inside text-sm text-[var(--text-tertiary)] space-y-1">
                    ...
                    <div className="relative">
                        <div className="absolute -left-[41px] bg-[var(--bg-input)] border-4 border-[var(--bg-card)] w-6 h-6 rounded-full"></div>
                        <h3 className="text-md font-bold text-heading">Phase 3 : Le Constructeur - Génération 3D</h3>
                        <span className="text-xs font-mono text-theme-muted mb-2 block">Sprints 5-6</span>
                        <ul className="list-disc list-inside text-sm text-[var(--text-tertiary)] space-y-1">
                    ...
                    {/* Phase 4 */}
                    <div className="relative">
                        <div className="absolute -left-[41px] bg-[#7C3AED] border-4 border-[var(--bg-card)] w-6 h-6 rounded-full shadow-[0_0_10px_rgba(124,58,237,0.5)]"></div>
                    ...
                    <div className="relative">
                        <div className="absolute -left-[41px] bg-[var(--bg-input)] border-4 border-[var(--bg-card)] w-6 h-6 rounded-full"></div>
                        <h3 className="text-md font-bold text-heading">Phase 5 : UX & Finalisation</h3>
