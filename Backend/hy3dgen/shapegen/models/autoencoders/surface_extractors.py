    ...
    def run(self, grid_logit, *, octree_resolution, **kwargs):
        ...
        if not hasattr(self, 'dmc'):
            try:
                ...
                print("Warning: 'diso' not found. Falling back to Marching Cubes (mc).")
                self.fallback_extractor = MCSurfaceExtractor()
                return self.fallback_extractor.run(grid_logit, mc_level=kwargs.get('mc_level', -1/512), bounds=kwargs.get('bounds', 1.01), octree_resolution=octree_resolution)
